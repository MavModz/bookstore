  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedProfile = {
        ...profile,
        address: {
          country: countryRef.current?.value || profile.address.country,
          cityState: cityStateRef.current?.value || profile.address.cityState,
          postalCode: postalCodeRef.current?.value || profile.address.postalCode,
          taxId: taxIdRef.current?.value || profile.address.taxId,
        },
      };
