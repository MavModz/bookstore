  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedProfile = {
        ...
        socialLinks: {
          facebook: facebookRef.current?.value || profile.socialLinks.facebook,
          twitter: twitterRef.current?.value || profile.socialLinks.twitter,
          linkedin: linkedinRef.current?.value || profile.socialLinks.linkedin,
          instagram: instagramRef.current?.value || profile.socialLinks.instagram,
        },
      };
          ...
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800">
              <Image
                width={80}
                height={80}
                src={profile.avatar && profile.avatar !== '/images/user/default-avatar.jpg' 
                  ? profile.avatar 
              ...
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  ...
                  <div className="col-span-2">
                    <Label>Bio</Label>
                    <Input type="text" defaultValue={profile.bio} disabled />
                  </div>
                </div>
              </div>
            </div>
